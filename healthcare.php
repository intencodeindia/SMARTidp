    ...
    <main role="main" class="main-content">
                    ...
                    <div class="col-lg-6 text-white">
                        <div class="mb-4">
                            <h2 class="subheadline text-uppercase" style="font-size: 2.2rem; font-weight: 900;">
                                <span class="gradient">Enterprise Content Management (ECM) for healthcare</span>
                            </h2>
                            <h1 class="display-3" style="font-size: 1.6rem; background:white; -webkit-background-clip: text; color: transparent;">Enhance patient care quality, lower costs, and reduce administrative burdens by
                                efficiently centralizing the management of all your documents and data.</h1>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Gain a comprehensive view of your patients, including diagnoses, treatment plans,
                                and medical histories. Access all critical documents in one application to enhance patient care effectiveness.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Streamlined Workflows with Intelligent Content Automation (ICA) reduce staff workloads by managing tasks efficiently,
                                eliminating manual processes, and ensuring deadlines are met.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class=" text-center">
                        <div class="card-body">
                            ...
                            <h4 class="card-title fw-bold"><br>Versatile integration options
                            </h4>
                            <p class="card-text">We offer versatile integration options,
                                supporting standards like HL7, CDA, FHIR, IHE, and DICOM for seamless connectivity with your clinic information systems (HIS).</p>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="container mt-md-5">
            ...
            <p class="text-center">The ECM platform goes beyond traditional content management by offering centralized storage, management,
                ...
                Intelligent automation enhances the efficiency of managing large volumes of data,
                enabling more accurate analysis and better utilization of medical information to improve patient outcomes.</p>
        </div>
                ...
                <div class="col">
                    <section class="icon-boxes is-animated does-repeat ce_rsce_oneo_icon_boxes icons-smaller">
                        ...
                        <div
                            ...
                            <h3>Obtain a complete view of patients and cases.</h3>
                            <div class="icon-boxes-item-text">
                                <p>Obtain a complete view of patients and cases, from admission to surgery, rounds, follow-up exams, and administration.
                                    Electronic patient records deliver customized information, aligned with your staff’s current workflows.
                                </p>
                            </div>
                        </div>
                        <!-- second card-->
                        <div
                            ...
                            <div class="icon-boxes-item-text">
                                <p>Automation in healthcare and administration reduces manual tasks like document filing, data reconciliation, and invoice verification.
                                    Intelligent assistants streamline processes, ensuring quality service through efficient management and automation.</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="icon-boxes-item-text">
                                <pBoost>Compatible with all formats, this solution functions as a vendor-neutral archive (VNA), supporting all common healthcare data formats.
                                    It allows saving and transferring image data in DICOM format, viewing studies with a powerful DICOM viewer,
                                    and storing unstructured documents as indexed PDFs with automatic data extraction. It also supports transmitting and storing structured data as FHIR resources.</p>
                            </div>
                        </div>
                        <!-- fourth card -->
                        <div
                            ...
                            <div class="icon-boxes-item-text">
                                <p>The patient education process in hospitals is often inefficient, involving printed forms that are signed and then digitized. With digital signatures,
                                    this process becomes quick and seamless, allowing patients to legally sign documents directly on a signature pad with a qualified signature.
                                </p>
                            </div>
                        </div>
                    </section>
                        ...
                        <div
                            ...
                            <div class="icon-boxes-item-text">
                                <pBoost>Information management in healthcare networks enables secure access to data across legally independent entities. With a multi-client solution,
                                    you can tailor information access to your organization’s structure. Effective case processing,patient records, and a connected IT system enhance data
                                    insights and facilitate rapid information exchange, ultimately improving patient care.</p>
                            </div>
                        </div>
                        <!-- sixth card -->
                        <div
                            ...
                            <div class="icon-boxes-item-text">
                                <p>EOur solution enables safe collaboration with external partners, whether through integrated portals or by participating in broader processes. With seamlessly integrated portals and end-to-end process flows,
                                    you can organize collaboration securely, maintain the highest quality standards, and enhance the efficiency of your workflows.
                                </p>
                            </div>
                        </div>
                    </section>

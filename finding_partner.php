    ...
    <img src="assets/images/partnerfinder/banner-partners-1.jpg" alt="Banner Image" style="width: 100%; height: auto" loading="lazy">
            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="ce_ser_head_2 block">
                        <div class="serhead-main-headline my-2">
                        <h2 class="responsive-heading1 fw-bold fs-1" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">
                    Power in unity <span class="gradient">- and knowledge</span>
                </h2>                            
                <p class="text-dark fw-bold fs-4">SmartIDP partner network</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row text-center mb-5">
                <h2 class="responsive-heading1 fw-bold fs-1" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">
                    One Tool for <span class="gradient fs-1">All Your Processes</span>
                </h2>
            </div>

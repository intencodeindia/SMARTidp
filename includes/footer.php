<footer class="page-footer" style="background: linear-gradient(260deg, #0090f9 0%, #00b09c 100%); ">
    <div class="mod_article ser-footer block" id="footer-redesign-de" style="margin-top:0px;margin-bottom: 0;">
        <div class="centered-wrapper ce_rsce_oneo_centered_wrapper_start  -color-inverted" style="margin-top: 0px; ">
            ...
            <div class="centered-wrapper-inner ">
                <div class="rs-columns ce_rs_columns_start">
                    <div class="ce_rs_column_start  rs-column -large-col-3-1 -large-first -large-first-row -medium-col-1-1 -medium-first -medium-last -medium-first-row -small-col-1-1 -small-first -small-last -small-first-row">
                        <p><a class="mr-4" title="Legal Information" href="javascript:void(0)">Legal&nbsp;Information</a> <a href="javascript:void(0)">Privacy&nbsp;Policy</a></p>
                    </div>
                    <div class="ce_rs_column_start  rs-column -large-col-3-1 -large-first-row -medium-col-1-1 -medium-first -medium-last -small-col-1-1 -small-first -small-last"> <!-- indexer::stop -->
                        <div class="social-icons">
                            ...
                            <a href="https://www.instagram.com/smartidp.ai/" target="_blank" rel="noopener" title="Instagram">

                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-lg-6 col-md-12 text-center">
                                ...
                                <div class="button-box ce_rsce_oneo_button" style="margin-bottom: 30px;">
                                    <a href="contact" class="button ce_rsce_oneo_button text-center" style="background-color: #0090f9; color: white; padding: 10px 20px; text-decoration: none; border-radius: 20px; width:150px;">Learn more</a>
                                </div>
                            </div>
                            <!-- Right Column (Image) -->
                            <div class="col-lg-6 col-md-12 text-center">

...
<div class="content-wrapper">
    <main role="main" class="main-content">
        ...
        <div class="container text-center">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4 my-md-5 my-3">
            ...
            <section class="row align-items-center">
              ...
              border-radius: 50px;">Learn How Migration Works with SmartIDP</a>
                ...
                <div class="col-md-6 py-3 text-center">
                    <img src="assets/images/banking_financial/fin10.jpeg" class="img-fluid" alt="Logistics" style="max-width: 95%;border-radius: 35px; height:50%" loading="lazy">
                </div>
            </section>
            <hr>
        </div>
